...
import { Activity, Mail, Lock, User, UserPlus, Users } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Supabase allows setting user metadata (like name) during signup
    ...
    if (signUpError) {
      ...
      // Typically wait for email confirmation, but assuming auto-confirm for now:
      navigate('/');
    }
  };
